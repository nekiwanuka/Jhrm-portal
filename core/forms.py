...
class BrandingSettingsForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'sidebar_active_link_color',
            'body_bg_color',
            'text_main_color',
            'text_muted_color',
            'text_light_color',
			'dashboard_active_feature_color',
			'dashboard_section_heading_color',
			'footer_enabled',
			'footer_left_text',
			'footer_right_text',
			'footer_link_text',
        ...
        widgets = {
			...
			'sidebar_hover_color': forms.TextInput(attrs={'type': 'color'}),
			'sidebar_header_color': forms.TextInput(attrs={'type': 'color'}),
            'sidebar_active_link_color': forms.TextInput(attrs={'type': 'color'}),
			...
			'dashboard_active_feature_color': forms.TextInput(attrs={'type': 'color'}),
			'dashboard_section_heading_color': forms.TextInput(attrs={'type': 'color'}),
